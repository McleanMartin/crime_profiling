"""
Django settings for crime_profiling project.
...
SECRET_KEY = 'django-insecure-awm4w$6(z@$11msh9j4(o%ti-$fcjdl9ncrk+a(sz%0r#8(25p'
...
ROOT_URLCONF = 'crime_profiling.urls'
...
WSGI_APPLICATION = 'crime_profiling.wsgi.application'
